...
int main()
{
	...
	Shader shaderProgram("default_vertex.vert", "default_fragment.frag", "default_geometry.geom");
	Shader normalsShader("default_vertex.vert", "normals.frag", "normals.geom");
